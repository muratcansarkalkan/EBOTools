...
from . import face_ebo_core as ebo_core
...
PROP_GAME_YEAR = "nba_live_head_game_year"
...
class NBA_LIVE_OT_ImportPlayer(bpy.types.Operator, ImportHelper):
    ...
    def execute(self, context):
        try:
            year = context.scene.nba_live_head_game_year
...
class NBA_LIVE_PT_EBOTools(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        import_box.prop(scene, "nba_live_head_game_year", text="Game")
        try:
            base_path = resolve_base_path(context, scene.nba_live_head_game_year)
...
def register():
    ...
    bpy.types.Scene.nba_live_head_game_year = EnumProperty(
        name="NBA Live Game",
...
def unregister():
    ...
    del bpy.types.Scene.nba_live_head_game_year
